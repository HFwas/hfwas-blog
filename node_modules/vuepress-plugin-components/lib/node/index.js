...
`)},O1=(e,t=!0)=>s=>(t&&B1(e),s.env.isDebug&&c.info("Options:",e),K(s,{id:"hope"}),{name:S,define:A1(e,t),extendsBundlerOptions:(o,i)=>{e?.components?.includes("VidStack")&&R(o,i,/^media-/),G(o,i,["@vuepress/helper","vuepress-shared"])},clientConfigFile:o=>E1(o,e,t)});export{B as AVAILABLE_SERVICES,h as SHARE_CONFIG,A as backToTopLocales,O1 as componentsPlugin,E as pdfLocaleConfig,O as siteInfoLocaleConfig};
