...
- [homebrew](https://gitee.com/cunkai/HomebrewCN)
...
- 执行`/bin/zsh -c "$(curl -fsSL https://gitee.com/cunkai/HomebrewCN/raw/master/Homebrew.sh)"`使用gitee脚本来安装，官方提供的会安装失败，
- 官方提供的安装失败，报错如下：

![image-20250707173750042](./images/image-20250707173750042.png)

### git

- 执行命令`brew install git`
- 配置代理：

```bash
hfwas@MacBookPro ~ % git config --global http.proxy 127.0.0.1:7890        
hfwas@MacBookPro ~ % git config --global https.proxy 127.0.0.1:7890
```

### nvm

- 访问地址，https://github.com/nvm-sh/nvm，
- 执行命令下载不同版本的node程序
...
<settings xmlns="http://maven.apache.org/SETTINGS/1.2.0"
  ...
  -->
  <localRepository>/Users/hfwas/repository</localRepository>
